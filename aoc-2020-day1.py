...
for a in numbers:
    ...
    if (remainder in numbers):
        print("Our two numbers are:", a, "and", remainder, ". Multiplying them together gives us the answer:", a * remainder)
        break

#Part 2 problem: find three numbers in the set above that sum to 2020. Then multiply them together.
for a in numbers:
    for b in numbers:
        d = (a + b)
        if (d < 2020):
            for c in numbers:
                e = (d + c)
                if (e == 2020):
                    print("Our three numbers are:", a, ",", b, "and", c, ". Multiplying them together gives us the answer:", a * b * c)
                    exit()
